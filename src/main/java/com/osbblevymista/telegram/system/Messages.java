...
public enum Messages {
    ...
    BUTTON_BARRIER2(144, "1 - +380 (67) 252 01 42 (Хуторівка);"),
    BUTTON_BARRIER3(145, "2 - +380 (67) 252 01 43 (Хуторівка);"),
    BUTTON_BARRIER4(146, "3 - +380 (67) 252 01 48 (Стрийська)."),
    ...
    CANCEL_SENDING_MESSAGE_GENERAL(149, "Буфер повідомлень очищений."),
    CANCEL_SENDING_MESSAGE_2(150, "Ви можете заново сформувати повідомлення яке буде розіслане всім користувачам після натискання кнопки '<i>" + BUTTON_SEND_MESSAGE_APPROVE.getText() + "</i>'"),
    CANCEL_SENDING_MESSAGE_APPEAL_SIMPLE(151, "Ви можете заново сформувати звернення та натиснути кнопку '<i>" + BUTTON_APPEAL_SIMPLE_APPROVE.getText() + "</i>'" +
            "Формування звернення зазвичай займає до 1хв. Дочекайтесь будь ласка відповіді.\n\n" +
            "Звернення опрацьовується правлінням протягом 3х робочих днів."),
    CANCEL_SENDING_MESSAGE_APPEAL_URGENT(152, "Ви можете заново сформувати звернення та натиснути кнопку '<i>" + BUTTON_APPEAL_URGENT_APPROVE.getText() + "</i>'" +
            "Формування звернення зазвичай займає до 1хв. Дочекайтесь будь ласка відповіді.\n\n" +
            "Звернення опрацьовується правлінням протягом одного дня."),
    STILL_SENDING(153, """
            Все ще розсилаю.
            """),
    GET_REQUEST_DATA_FOR_MYIDIM_1(154, """
            Прикріплені файли до звернення були надіслані правлінню ОСББ, але не відображаються у зверненні.
            """);
