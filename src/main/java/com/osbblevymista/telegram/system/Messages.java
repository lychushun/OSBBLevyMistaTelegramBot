...
public enum Messages {
    MISSING_COOKIE(100, """
            Ви не авторизовані у системі МійДім. Будь ласка авторизуйтесь у системі <u>МійДім</u>.\s
            Якщо у вас нема доступу до системи МійДім перейдіть за посилання https://miydimonline.com.ua/ та зареєструйтесь.
    ...
    LOG_OUT_MIYDIM(127, """
            Ви успішно вийшли із системи МійДім.
            """),
    ...
    LAST_APPEAL(139, """
            Ви успішно сформували нове звернення. 
            
            Для того, щоб перевірити статус виконання ви можите перейти за посиланням, 
            або зайти у розділ <i>Звернення</i>-><i>Переглянути звернення</i>
            """);
