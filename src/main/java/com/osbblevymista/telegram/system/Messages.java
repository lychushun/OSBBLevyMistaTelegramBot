...
public enum Messages {
    MISSING_COOKIE(100, """
            ...
            Якщо у Вас немає доступу до системи МійДім перейдіть за посилання https://miydimonline.com.ua/ та зареєструйтесь.
    ...
    CREATING_APPEAL(129, """
            Звернення в процесі створення. Це може заняти якийсь час. Будь ласка зачекайте.
            """),
