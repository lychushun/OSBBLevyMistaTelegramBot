...
import com.osbblevymista.telegram.view.pages.ArrearsPage;
...
import static com.osbblevymista.telegram.system.Messages.GET_REQUEST_DATA_FOR_MYIDIM_1;
        ...
        OSBBExecutorListener osbbExecutorListenerGet = new OSBBExecutorListener() {
            ...
            public ExecutorListenerResponse doExecute(KeyboardParam keyboardParam) throws IOException, URISyntaxException {
                ...
                if (arrearsMiyDim.isLogin()) {
                    ...
                    executorListenerResponse.messages.add(GET_REQUEST_DATA_FOR_MYIDIM_1.getMessage());
