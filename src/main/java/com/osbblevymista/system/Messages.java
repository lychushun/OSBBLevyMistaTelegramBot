...
public enum Messages {
    MISSING_LOG_AND_PASS(100, """
            Відсутній логин та пароль до сисеми МійДім. Будь ласка перейдіть в налаштування на добавте Логин та Пароль.\s
    ...
    INSERT_LOGIN(101, "Будь ласка введіть логин до системи МійДім\n"),
    ...
    RESPONSE_SIMPLE_REQUEST_DATA_FOR_MYIDIM(109, "Ви створили нове звернення. " +
            "Ми опрацюємо його протягом 3х робочих днів. " +
    ...
    RESPONSE_URGENT_REQUEST_DATA_FOR_MYIDIM(111, "Ви створили терміновий запит. " +
            "Ми опрацюємо його протягом одного. " +
            "Для перевірки статусу перейдіть у розділ  '" + Actions.BUTTON_APPEAL_REVIEW.getText() + "'"),
    ...
    POLL(117, """
            ...
            Якщо потрібно надіслати індивідуальний запит, будь ласка натисніть \"Створити звичайне\" чи \"Створити термінове\" кнопнку та надішліть текст.
            """),
    ...
    REPORTS(120, "Тут ви знайдете звіти та документи ОСББ \'Леви Міста\'."),
    ...
    START_NEW_PERSON(122, """
            ...
            1. Заповніть <b>Логин</b> та <b>Пароль</b> від системи <b>МійДім</b>(<i>https://miydimonline.com.ua/</i>) в розділі <u>Налаштування</u>;
